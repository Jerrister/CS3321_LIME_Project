...
import Neo4jVision from '../services/neo4jvision';
...
export default function Neo4_VizPage({Content, setContent}) {
    ...
    return (
        ...
        <Breadcrumb.Item> Literature Note Graph </Breadcrumb.Item>

        <SearchBar InPage={"Neo4j"} />
